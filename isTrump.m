function [fpr,tpr,auc]=isTrump(xTe,yTe,thresh);
...
if exist('thresh')~=1,thresh=0;end;
...
for i=1:length(yTe)
	...
	%%
    if pred>0,	pstring='Trump';else pstring='Obama';end;
    if truth==1,tstring='Trump';else tstring='Obama';end;
    if yTe(i)~=pred,
